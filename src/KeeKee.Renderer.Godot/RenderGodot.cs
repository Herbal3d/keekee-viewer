...
namespace KeeKee.Renderer.Godot {
    /// <summary>
    /// A renderer that will someday make map pages of the sim.
    /// At the moment it's just a null renderer.
    /// </summary>
    public class RendererGodot : IRenderProvider {
        private KLogger<RendererGodot> m_log;

        public RendererGodot(KLogger<RendererGodot> pLog) {
            m_log = pLog;
