...
namespace KeeKee.Renderer.Null {
    /// <summary>
    /// A renderer that will someday make map pages of the sim.
    /// At the moment it's just a null renderer.
    /// </summary>
    public class RendererNull : IRenderProvider {
        private KLogger<RendererNull> m_log;

        public RendererNull(KLogger<RendererNull> pLog) {
            m_log = pLog;
