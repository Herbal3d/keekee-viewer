...
#pragma warning restore 0067
        ...
        public LLAgent(OMV.GridClient theClient) {
            ...
            if (KeeKeeBase.Instance.AppParams.HasParameter("World.LL.Agent.PreMove.RotFudge")) {
                m_rotFudge = KeeKeeBase.Instance.AppParams.ParamFloat("World.LL.Agent.PreMove.RotFudge");
            }
            if (KeeKeeBase.Instance.AppParams.HasParameter("World.LL.Agent.PreMove.MoveFudge")) {
                m_moveFudge = KeeKeeBase.Instance.AppParams.ParamFloat("World.LL.Agent.PreMove.MoveFudge");
            }
            if (KeeKeeBase.Instance.AppParams.HasParameter("World.LL.Agent.PreMove.FlyFudge")) {
                m_flyFudge = KeeKeeBase.Instance.AppParams.ParamFloat("World.LL.Agent.PreMove.FlyFudge");
            }
            if (KeeKeeBase.Instance.AppParams.HasParameter("World.LL.Agent.PreMove.RunFudge")) {
                m_runFudge = KeeKeeBase.Instance.AppParams.ParamFloat("World.LL.Agent.PreMove.RunFudge");
            }
        }
